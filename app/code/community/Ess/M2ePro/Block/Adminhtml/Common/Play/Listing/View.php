    ...
    public function __construct()
    {
        ...
        if (!Mage::helper('M2ePro/View_Common_Component')->isSingleActiveComponent()) {
            $headerText = Mage::helper('M2ePro')->__(
                ...
                Mage::helper('M2ePro/Component_Play')->getTitle()
            );
        } else {
...
JAVASCRIPT;
        ...
        $viewHeaderBlock = $this->getLayout()->createBlock(
            ...
            array('listing' => Mage::helper('M2ePro/Component_Play')->getCachedObject('Listing',$listingData['id']))
        );
        //------------------------------
...
HTML;
    ...
    public function getAddProductsDropDownItems()
    {
        ...
        $listingData = Mage::helper('M2ePro/Data_Global')->getValue('temp_data');
        $backUrl = Mage::helper('M2ePro')->makeBackUrlParam('*/adminhtml_common_play_listing/view', array(
            'id' => $listingData['id']
        ));
