    ...
    extends Ess_M2ePro_Model_Connector_Play_Requester
{
    ...
    /**
     * @var Ess_M2ePro_Model_Play_Listing_Product_Action_Logger
     */
    ...
    /**
     * @var Ess_M2ePro_Model_Play_Listing_Product_Action_Type_Validator[]
     */
    protected $validatorsObjects = array();

    /**
     * @var Ess_M2ePro_Model_Play_Listing_Product_Action_Type_Request[]
     */
    ...
    /**
     * @return Ess_M2ePro_Model_Play_Listing_Product_Action_Logger
     */
    protected function getLogger()
    {
        if (is_null($this->logger)) {

            /** @var Ess_M2ePro_Model_Play_Listing_Product_Action_Logger $logger */

            $logger = Mage::getModel('M2ePro/Play_Listing_Product_Action_Logger');
    ...
    protected function getConfigurator()
    {
        if (is_null($this->configurator)) {
            ...
            $configurator = Mage::getModel('M2ePro/Play_Listing_Product_Action_Configurator');
     ...
     * @return Ess_M2ePro_Model_Play_Listing_Product_Action_Type_Validator
     */
    protected function getValidatorObject(Ess_M2ePro_Model_Listing_Product $listingProduct)
    {
        if (!isset($this->validatorsObjects[$listingProduct->getId()])) {
            ...
            /** @var $validator Ess_M2ePro_Model_Play_Listing_Product_Action_Type_Validator */
            $validator = Mage::getModel(
                'M2ePro/Play_Listing_Product_Action_Type_'.$this->getOrmActionType().'_Validator'
            );
    ...
    protected function getRequestObject(Ess_M2ePro_Model_Listing_Product $listingProduct)
    {
        if (!isset($this->requestsObjects[$listingProduct->getId()])) {
            ...
            /* @var $request Ess_M2ePro_Model_Play_Listing_Product_Action_Type_Request */
            $request = Mage::getModel(
                'M2ePro/Play_Listing_Product_Action_Type_'.$this->getOrmActionType().'_Request'
            );
    ...
    protected function buildRequestDataObject(Ess_M2ePro_Model_Listing_Product $listingProduct, array $data)
    {
        if (!isset($this->requestsDataObjects[$listingProduct->getId()])) {
            ...
            /** @var Ess_M2ePro_Model_Play_Listing_Product_Action_RequestData $requestData */
            $requestData = Mage::getModel('M2ePro/Play_Listing_Product_Action_RequestData');
