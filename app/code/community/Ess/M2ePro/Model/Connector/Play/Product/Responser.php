...
abstract class Ess_M2ePro_Model_Connector_Play_Product_Responser
    extends Ess_M2ePro_Model_Connector_Play_Responser
{
    ...
    /**
     * @var Ess_M2ePro_Model_Play_Listing_Product_Action_Type_Response[]
     */
    ...
    public function __construct(array $params = array())
    {
        ...
        foreach ($this->params['products'] as $id => $listingProductData) {
            try {
                $this->listingsProducts[] = Mage::helper('M2ePro/Component_Play')
    ...
    protected function inspectProducts()
    {
        ...
        $inspector = Mage::getModel('M2ePro/Play_Synchronization_Templates_Inspector');
    ...
    /**
     * @param Ess_M2ePro_Model_Listing_Product $listingProduct
     * @return Ess_M2ePro_Model_Play_Listing_Product_Action_Type_Response
     */
    protected function getResponseObject(Ess_M2ePro_Model_Listing_Product $listingProduct)
    {
        if (!isset($this->responsesObjects[$listingProduct->getId()])) {
            ...
            /* @var $response Ess_M2ePro_Model_Play_Listing_Product_Action_Type_Response */
            $response = Mage::getModel(
                'M2ePro/Play_Listing_Product_Action_Type_'.$this->getOrmActionType().'_Response'
            );
