...
class Ess_M2ePro_Model_Connector_Play_Product_List_MultipleRequester
    extends Ess_M2ePro_Model_Connector_Play_Product_Requester
{
    ...
    private function addSkusToQueue(array $skus)
    {
        ...
        $lockItem->setNick('play_list_skus_queue_' . $this->account->getId());
     ...
     * @return Ess_M2ePro_Model_Play_Listing_Product_Action_Type_List_Validator_General
     */
    private function getGeneralValidatorObject(Ess_M2ePro_Model_Listing_Product $listingProduct)
    {
        if (!isset($this->generalValidatorsObjects[$listingProduct->getId()])) {
            ...
            /** @var $validator Ess_M2ePro_Model_Play_Listing_Product_Action_Type_List_Validator_General */
            $validator = Mage::getModel(
                'M2ePro/Play_Listing_Product_Action_Type_List_Validator_General'
            );
    ...
    /**
     * @param Ess_M2ePro_Model_Listing_Product $listingProduct
     * @return Ess_M2ePro_Model_Play_Listing_Product_Action_Type_List_Validator_Sku_General
     */
    private function getSkuGeneralValidatorObject(Ess_M2ePro_Model_Listing_Product $listingProduct)
    {
        if (!isset($this->skuGeneralValidatorsObjects[$listingProduct->getId()])) {
            ...
            /** @var $validator Ess_M2ePro_Model_Play_Listing_Product_Action_Type_List_Validator_Sku_General */
            $validator = Mage::getModel(
                'M2ePro/Play_Listing_Product_Action_Type_List_Validator_Sku_General'
            );
    ...
    /**
     * @param Ess_M2ePro_Model_Listing_Product $listingProduct
     * @return Ess_M2ePro_Model_Play_Listing_Product_Action_Type_List_Validator_Sku_Search
     */
    private function getSkuSearchValidatorObject(Ess_M2ePro_Model_Listing_Product $listingProduct)
    {
        if (!isset($this->skuSearchValidatorsObjects[$listingProduct->getId()])) {
            ...
            /** @var $validator Ess_M2ePro_Model_Play_Listing_Product_Action_Type_List_Validator_Sku_Search */
            $validator = Mage::getModel(
                'M2ePro/Play_Listing_Product_Action_Type_List_Validator_Sku_Search'
            );
    ...
    /**
     * @param Ess_M2ePro_Model_Listing_Product $listingProduct
     * @return Ess_M2ePro_Model_Play_Listing_Product_Action_Type_List_Validator_Sku_Existence
     */
    private function getSkuExistenceValidatorObject(Ess_M2ePro_Model_Listing_Product $listingProduct)
    {
        if (!isset($this->skuExistenceValidatorsObjects[$listingProduct->getId()])) {
            ...
            /** @var $validator Ess_M2ePro_Model_Play_Listing_Product_Action_Type_List_Validator_Sku_Existence */
            $validator = Mage::getModel(
                'M2ePro/Play_Listing_Product_Action_Type_List_Validator_Sku_Existence'
            );
    ...
    /**
     * @param Ess_M2ePro_Model_Listing_Product $listingProduct
     * @return Ess_M2ePro_Model_Play_Listing_Product_Action_Type_Request
     */
    protected function getRequestObject(Ess_M2ePro_Model_Listing_Product $listingProduct)
    {
        if (!isset($this->requestsObjects[$listingProduct->getId()])) {
            ...
            /* @var $request Ess_M2ePro_Model_Play_Listing_Product_Action_Type_List_Request */
            $request = Mage::getModel(
                'M2ePro/Play_Listing_Product_Action_Type_List_Request'
            );
