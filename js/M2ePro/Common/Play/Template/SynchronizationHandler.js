CommonPlayTemplateSynchronizationHandler = Class.create();
CommonPlayTemplateSynchronizationHandler.prototype = Object.extend(new CommonHandler(), {
    ...
    listMode_change: function()
    {
        ...
        } else if ($('list_mode').value == M2ePro.php.constant('Ess_M2ePro_Model_Play_Template_Synchronization::LIST_MODE_YES')) {
            $('magento_block_play_template_synchronization_list_rules').show();
        } else {
            $('magento_block_play_template_synchronization_list_rules').hide();
        }
    },
    ...
    relistMode_change: function()
    {
        if ($('relist_mode').value == M2ePro.php.constant('Ess_M2ePro_Model_Play_Template_Synchronization::RELIST_MODE_NONE')) {
            ...
            $('magento_block_play_template_synchronization_relist_rules').hide();
        } else if ($('relist_mode').value == M2ePro.php.constant('Ess_M2ePro_Model_Play_Template_Synchronization::RELIST_MODE_YES')) {
            $('relist_filter_user_lock_tr_container').show();
            $('magento_block_play_template_synchronization_relist_rules').show();
        } else {
            $('relist_filter_user_lock_tr_container').hide();
            $('magento_block_play_template_synchronization_relist_rules').hide();
        }
    ...
    reviseQty_change: function()
    {
        if (this.value == M2ePro.php.constant('Ess_M2ePro_Model_Play_Template_Synchronization::REVISE_UPDATE_QTY_YES')) {
            ...
            $('revise_update_qty_max_applied_value_mode').value = M2ePro.php.constant('Ess_M2ePro_Model_Play_Template_Synchronization::REVISE_MAX_AFFECTED_QTY_MODE_OFF');
        }
    },
    ...
    reviseQtyMaxAppliedValueMode_change: function()
    {
        ...
        if (this.value == M2ePro.php.constant('Ess_M2ePro_Model_Play_Template_Synchronization::REVISE_MAX_AFFECTED_QTY_MODE_ON')) {
